    ...
    'assets': {
        'web._assets_primary_variables': [
            ...
            (
                'after', 
                'web/static/src/scss/primary_variables.scss', 
                'muk_web_theme/static/src/scss/primary_variables_custom.scss'
            ),
        ],
        'web.assets_backend': [
            'muk_web_theme/static/src/scss/secondary_variables.scss',
            'muk_web_theme/static/src/scss/fields_extra_custom.scss',
