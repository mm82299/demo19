...
class crm_claim(models.Model):
    ...
    id_data = fields.Integer('ID', readonly=True)
    ...
    date = fields.Datetime('Claim Date', default=lambda self: self.env.context.get('date', fields.Datetime.now()))
    ...
    root_cause_ids = fields.One2many('crm.claim.root.cause', 'claim_id', string='Root Causes')
    resolution_action_ids = fields.One2many('crm.claim.resolution.action', 'claim_id', string='Resolution Actions')
    ...
    def create(self, vals_list):
        ...
        return super(crm_claim, self).create(vals_list)
